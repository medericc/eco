...
export const companyLogos: CompanyLogo[] = [
 ...
 "11 Points",
  ...
  export const base: BaseItem[] = [
   ...
   { id: "2", title: "Avec la France", text: "Inès a remporté l'EuroChallenger U18 d'Héraklion en 2021, puis s'est illustrée à l'Eurobasket U20 2023 en terminant meilleure joueuse de la finale.", backgroundUrl: "/card-3.svg", iconUrl: assets.baseIcon5, imageUrl: assets.baseImage2, light: true },
   
    { id: "3", title: "Double Championnat", text: "Inès a remporté deux saisons régulières de l'Atlantic 10, soit les deux tiers des titres de Rhode Island dans la conférence Atlantic 10.", backgroundUrl: "/card-1.svg", iconUrl: assets.baseIcon7, imageUrl: assets.baseImage2, light: true },
   
    { id: "4", title: "Récompense", text: "Pour sa dernière saison avec Rhody, Inès figure dans la 1st Team Défensive de l'A10 et devient la meilleure passeuse de Rhody au XXIe siècle.", backgroundUrl: "/card-2.svg", iconUrl: assets.baseIcon7, imageUrl: assets.baseImage2 },
      { id: "5", title: "Championne A10", text: "Inès a remporté le seul titre Atlantic 10 de l'histoire de Rhode Island et est la joueuse la plus victorieuse de Rhody grâce à une série de victoires inédite.", backgroundUrl: "/card-3.svg", iconUrl: assets.baseIcon7, imageUrl: assets.baseImage2, light: true },
