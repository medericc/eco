import { assets } from "../assets";
  ...
  export const base: BaseItem[] = [
    { id: "0", title: "L'Écologie", text: "Étude des interactions entre les organismes vivants et leur environnement, avec le milieu physique ou avec d'autres êtres vivants.", backgroundUrl: "/card-1.svg", iconUrl: assets.baseIcon3, imageUrl: assets.baseImage2 },
    { id: "1", title: "L'Écosystème", text: "Ensemble d’interactions entre les organismes et leur environnement physique. Ils forment la biosphère, les zones où la vie est possible sur Terre.", backgroundUrl: "/card-2.svg", iconUrl: assets.baseIcon8, imageUrl: assets.baseImage2, light: true },
    { id: "2", title: "Les Biomes", text: "Grandes zones climatiques regroupant des écosystèmes similaires, qui sont influencés par des facteurs abiotiques et biotiques.", backgroundUrl: "/card-3.svg", iconUrl: assets.baseIcon4, imageUrl: assets.baseImage2 },
